...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validasi: Minimal satu layanan harus diisi
    if ($reguler + $premium + $treatment == 0) {
        echo "<script>alert('Minimal satu service dipilih!'); window.history.back();</script>";
        exit();
    }
    ...
    $id_katalog = 1;  // Hardcoded id_katalog
    $stat_pembayaran = 1;
